...
\begin{document}
	...
	\paragraph{}
	IIn this painting the perspective also seems to be well respected. The observation that in each pair, one painting respects perspective and the other not, is then not verified for the pair that illustrated this report.
